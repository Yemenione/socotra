        ...
        <div className="flex h-screen bg-sand-50">
            ...
            <aside className="w-64 bg-rich-black text-sand-50 flex flex-col">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <Link href="/admin/reservations" className="flex items-center gap-3 px-4 py-3 rounded-md text-sand-50/80 hover:bg-gold-500 hover:text-rich-black transition-all">
                        <div className="w-5 h-5 flex items-center justify-center">📅</div>
                        <span className="font-bold text-sm tracking-wide">RESERVATIONS</span>
                    </Link>
                    <Link href="/admin/categories" className="flex items-center gap-3 px-4 py-3 rounded-md text-sand-50/80 hover:bg-gold-500 hover:text-rich-black transition-all">
                        <MenuIcon size={20} />
                        <span className="font-bold text-sm tracking-wide">CATEGORIES</span>
                    </Link>
                    <Link href="/admin/items" className="flex items-center gap-3 px-4 py-3 rounded-md text-sand-50/80 hover:bg-gold-500 hover:text-rich-black transition-all">
