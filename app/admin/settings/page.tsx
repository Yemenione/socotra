                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="flex items-center gap-4">
                                    {formData.reservationImage && (
                                        <img src={formData.reservationImage} alt="Reservation BG" className="h-20 w-40 object-cover rounded-lg border border-sand-200" />
                                    )}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4">
                                    {formData.signatureImage && (
                                        <img src={formData.signatureImage} alt="Signature" className="h-20 w-20 object-cover rounded-lg border border-sand-200" />
                                    )}
                                    <button type="button" className="bg-rich-black text-white px-4 py-2 rounded-lg text-xs font-bold hover:bg-gold-500 hover:text-rich-black transition-colors relative overflow-hidden">
